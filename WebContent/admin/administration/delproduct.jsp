...
<div id="siteBox">
  ...
  <%@include file="/WEB-INF/include/menuAdministracion.jsp" %>
    ...
    <div id="contentRight">
        ...
        Producto prod = ProductoDao.getInstance().getProduct(request.getParameter("prod"));
        if (prod != null){ %>
        <p>
        ...
        <a style="margin-left: 2em" href="${pageContext.request.contextPath}/admin/administration/products_administration.jsp">No eliminar</a>
        <a style="margin-left: 15em" href="${pageContext.request.contextPath}/DeleteProductServlet?prod=<%= prod.getCodigo() %>">Eliminar producto</a>
        <% } else{ %>
        <p>
