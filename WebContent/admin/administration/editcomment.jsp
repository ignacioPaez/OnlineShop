...
<div id="siteBox">
  ...
  <%@include file="/WEB-INF/include/menuAdministracion.jsp" %>
    ...
    <div id="contentRight">
        ...
        Comentario comment = ComentarioDao.getInstance().getComment(request.getParameter("cod"));
        if (comment != null){ %>
        <p>
        <span class="header">Editar comentario: <span class="headerComplement"><%= request.getParameter("cod") %></span></span>
        <form method="post" name="editComment" action="${pageContext.request.contextPath}/EditCommentServlet">
