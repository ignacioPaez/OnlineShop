...
<div id="siteBox">
  ...
  <%@include file="/WEB-INF/include/menuAdministracion.jsp" %>
    ...
    <div id="contentRight">
        ...
        Usuario user = UsuarioDao.getInstance().getUser(request.getParameter("user"));
        if (user == null){
            ...
            <jsp:forward page="${pageContext.request.contextPath}/admin/administration/user_administration.jsp" />
        <% }else{ %>
            
            <div class="title">
					<span class="title_icon"><img
						src="${pageContext.request.contextPath}/images/template/bullet3.gif"
						alt="" title=""></span> Editar Usuario
				</div>
				
				<div class="feat_prod_box_details">
				<div class="contact_form">
				<div class="form_subtitle">Email: <%= user.getMail() %></div>
                <form action="${pageContext.request.contextPath}/EditUserCompleteServlet" method="post" name="editUser">
                    
                    <input type="hidden" name="mail" value="<%= user.getMail() %>" />
                    Nombre <br />
                    <input type="text" name="nombre" maxlength="100" size="43" class=":alpha :required :only_on_blur" value="<%= user.getNombre() %>" /><br /><br />
                    
                    Direcci&oacute;n <br />
                    <input type="text" name="dir" maxlength="200" size="43" class=":required :only_on_blur" value="<%= user.getDir() %>" /><br /><br />
                    
                    Permisos<br />
                    <select name="perm">
                        <% if (user.getPermisos() == 'a' && AdminDao.getInstance().anyAdmin() == 1){%>
                    ...
                    <br /><br />
                    <div class="form_row">
							<input name="edit" type="submit" value="Editar" class="register" />
						</div>
