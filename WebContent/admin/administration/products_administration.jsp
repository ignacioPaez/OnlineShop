...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="siteBox">
            ...
            session.removeAttribute("productoEnCursoEdit");%>
					...
					<span class="title_icon"><img
						...
						alt="" title=""></span> Administraci&oacute;n de productos
					</div>
                    
                    
                        <a name="anadirprod" href="${pageContext.request.contextPath}/admin/administration/addproduct.jsp">A&ntilde;adir Producto</a> <br />
        ...
        if (productos != null && productos.size() != 0) {%>
					...
					<span class="title_icon"><img
						src="${pageContext.request.contextPath}/images/template/bullet3.gif"
						alt="" title=""></span> Listado de productos
					</div>
                       
						 <div class="feat_prod_box_details">
                         <table class="cart_table">
                         <tbody>
                           <tr class="cart_title"><td>Nombre</td><td>Precio</td><td>Stock</td><td>Autor</td><td>&nbsp;</td></tr>
                            ...
                            <tr class="contentTable">
                                ...
                                <td><%= prod.getDesc()%></td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/admin/administration/modifyprod.jsp?prod=<%= prod.getCodigo()%>">
                                        <img title="Editar producto" alt="Editar producto" src="${pageContext.request.contextPath}/images/icons/editProd.png"/>
                                    </a>&nbsp;&nbsp;
                                    <a href="${pageContext.request.contextPath}/admin/administration/delproduct.jsp?prod=<%= prod.getCodigo()%>">
                                        <img title="Borrar producto" alt="Borrar producto" src="${pageContext.request.contextPath}/images/icons/deleteProd.png"/>
                                    </a>
                                </td>
                            </tr>
                            <% }%>
